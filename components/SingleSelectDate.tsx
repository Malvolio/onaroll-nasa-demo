/**
 * Taken with slight modifications from https://github.com/its-danny/use-lilius/blob/main/examples/datepicker/single-select.tsx
 */
...
export const SingleSelectDate: React.FC<{
  ...
  const onInputBlur = () => {
    ...
    const parsed = parse(parts.join("/"), selectedDateFormat, new Date());
